...
<template>
    <div class="card w-96 bg-base-100 shadow-lg">
        <figure class="relative">
            <img src="https://daisyui.com/images/store/saas-landingpage.png" alt="vite" />
            ...
            <div class="bg-base-100 pointer-events-none absolute -top-3/4 right-1/4 z-[3] aspect-square w-1/2 rounded-full opacity-60 blur-3xl"></div>
        </figure>
        <div class="card-body">
            <h2 class="card-title">
                Hello<div class="badge badge-primary">{{ msg }}</div>
            </h2>
            <div class="mockup-code">
                <pre data-prefix="1"><code>components/HelloWorld.vue</code></pre>
            </div>
            <p>
                Install
                <a class="link" href="https://github.com/vuejs/language-tools" target="_blank">
                    Volar
                </a>
